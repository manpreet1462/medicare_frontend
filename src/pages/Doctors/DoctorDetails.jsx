                    ...
                    <div className='md:col-span-2'>
                        <div className="flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <h3 className='text-headingColor text-[22px] leading-9 mt-3 font-semibold'>{name}</h3>
                                <div className="flex items-center gap-[6px]">
                                    ...
                                    lg:text-[16px] lg:leading-7 font-[400] text-textColor'>({totalRating})</span>
                                </div>
                        ...
                        <div className='mt-[50px] border-b border-solid border-[#0066ff34]'>
                            <button onClick={() => { setTab('about') }}
                                className={`${tab === 'about' && 'border-b border-solid border-primaryColor'} py-2 px-5 mr-5 text-[16px] leading-7 
                            text-headingColor font-semibold`}>About</button>
                            <button onClick={() => { setTab('feedback') }}
                                className={`${tab === 'feedback' && 'border-b border-solid border-primaryColor'} py-2 px-5 mr-5 text-[16px] leading-7 
