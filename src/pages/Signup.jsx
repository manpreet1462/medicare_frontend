                        ...
                        <form onSubmit={submitHandler}>
                            <div className="mb-5">
                                <input
                                    ...
                                    className="w-full pr-4 border-b border-solid border-[#0066ff61] 
                            ...
                            <div className="mb-5 flex items-center justify-between">
                                <label className='text-headingColor font-bold text-[16px] leading-7'>
                                    ...
                                    <select name="role" value={formData.role}
                                        onChange={handleInputChange} className='text-textColor font-semibold 
                            ...
                            <div className="mb-5 flex items-center gap-3">
                                {selectedFile && <figure figure className='w-[60px] h-[60px] rounded-full border-2 border-solid
                            ...
                            <div className="mt-7 ">
                                <button disabled={loading && true} type='submit' className='w-full bg-primaryColor text-white text-[18px] 
                            leading-[30px] rounded-lg px-4 py-3 hover:text-blue-800'>{loading ? <HashLoader size={35} color='#ffffff' /> : 'Sign Up'}</button>
                            </div>
                            <p className='mt-5 text-textColor text-center'>
                                Already have an account? <Link to={'/login'} className='text-primaryColor
                            font-medium ml-1 hover:text-blue-900'>Login</Link></p>
                        </form>
                    </div>
                </div>
            </div >
